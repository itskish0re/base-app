-- app_entity_screen_column — financial_years grid
...
CROSS JOIN (
    VALUES
        ('code', 'Year', true, 10, 20, false, 'left', 'badge'),
        ('name', 'Name', true, 20, 40, false, 'left', 'text'),
...
WHERE m.menu_code = 'financial_year'
