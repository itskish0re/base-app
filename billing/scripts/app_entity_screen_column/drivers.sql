-- app_entity_screen_column — drivers grid
...
CROSS JOIN (
    VALUES
        ('name', 'Name', true, 10, 200, 120, false, 'left', 'text'),
        ('mobile', 'Mobile', true, 20, 140, 100, false, 'left', 'text'),
        ('truck_id', 'Truck', true, 30, 120, 100, false, 'right', 'number'),
        ('is_enabled', 'Enabled', true, 40, 100, NULL::int, false, 'center', 'boolean'),
        ('is_active', 'Active', true, 50, 100, NULL::int, false, 'center', 'boolean')
