-- app_entity_screen_field — name_boards form
...
CROSS JOIN (
    VALUES
        ...
        ('code', 'Code', true, 20, 'text', false),
        ('owner_name', 'Owner name', true, 30, 'text', false),
        ('owner_phone', 'Owner phone', true, 40, 'text', false)
