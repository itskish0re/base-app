...
CROSS JOIN (
    VALUES
        ('unit_id', 'integer', true, true, true, false, false, NULL::int, NULL::int, NULL::text),
        ('code', 'text', true, true, true, true, true, NULL::int, 64, NULL::text),
        ('name', 'text', true, true, true, true, true, NULL::int, 256, NULL::text),
        ('is_fixed', 'boolean', true, true, true, true, false, NULL::int, NULL::int, NULL::text),
