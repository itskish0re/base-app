...
CROSS JOIN (
    VALUES
        ('driver_id', 'integer', true, true, true, false, false, NULL::int, NULL::int),
        ('name', 'text', true, true, true, true, true, NULL::int, 256),
        ('mobile', 'text', true, true, true, true, true, NULL::int, 32),
        ('truck_id', 'integer', true, true, true, true, true, NULL::int, NULL::int),
