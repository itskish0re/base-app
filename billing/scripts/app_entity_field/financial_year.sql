-- app_entity_field — financial_year
...
CROSS JOIN (
    VALUES
        ('financial_year_id', 'integer', true, true, true, false, false, NULL::int, NULL::int, NULL::text),
        ('code', 'text', true, true, true, true, true, NULL::int, 64, NULL::text),
        ('name', 'text', true, true, true, false, true, NULL::int, 256, NULL::text),
...
WHERE e.entity_name = 'financial_year'
