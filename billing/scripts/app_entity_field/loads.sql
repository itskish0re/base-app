...
CROSS JOIN (
    VALUES
        ...
        ('consignor_id', 'integer', true, false, true, true, true, NULL::int, NULL::int, NULL::text),
        ('consignor_name', 'text', true, true, true, false, false, NULL::int, 256, NULL::text),
        ('consignee_id', 'integer', true, false, true, true, true, NULL::int, NULL::int, NULL::text),
        ('consignee_name', 'text', true, true, true, false, false, NULL::int, 256, NULL::text),
        ('as_per_bill', 'boolean', true, true, true, true, false, NULL::int, NULL::int, 'false'::text),
